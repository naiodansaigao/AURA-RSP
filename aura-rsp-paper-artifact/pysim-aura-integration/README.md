...
This research copy contains the in-tree AURA-RSP/osmo-smdpp integration.
Start with [README_AURA_INTEGRATION.md](README_AURA_INTEGRATION.md).  Upstream
provenance is recorded in [UPSTREAM.md](UPSTREAM.md).
