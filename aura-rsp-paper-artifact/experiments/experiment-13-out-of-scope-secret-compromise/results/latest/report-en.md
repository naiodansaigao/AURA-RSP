...
- Issuer backend: `portable_signature_commitment_harness`
...
This run used the portable Ed25519 commitment harness for EUM/MNO issuance. It validates private-key compromise causality but does not claim to implement BBS+ or zero knowledge. Run `--backend production` inside the AURA WSL environment for the production BBS+ path.
